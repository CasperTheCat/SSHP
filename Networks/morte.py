...
#                })
    ...
    def predictSet(dataset, filename):
        # Predict th
        print("Predicting the %s set" % dataset)
    ...
    predictSet(TEST1, "/Scratch/cwa3/500/out_1.csv")
    predictSet(TEST10, "/Scratch/cwa3/500/out_10.csv")
    predictSet(TEST20, "/Scratch/cwa3/500/out_20.csv")
    predictSet(TEST30, "/Scratch/cwa3/500/out_30.csv")
    predictSet(TEST40, "/Scratch/cwa3/500/out_40.csv")
    predictSet(TEST50, "/Scratch/cwa3/500/out_50.csv")
    predictSet(TEST60, "/Scratch/cwa3/500/out_60.csv")
    predictSet(TEST66, "/Scratch/cwa3/500/out_66.csv")
    sess.close()
